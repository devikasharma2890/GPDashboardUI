...
//Each component specifies a interactive representation of actual SharePoint list data
//Employee Onboard Component is pointing to : https://goodpack.sharepoint.com/sites/PowerAppsSharePoint/Lists/New%20User%20Request/AllItems.aspx
class EmployeeOnboard extends Component {
  ...
  CallRESTAPI = function (endPointUrl) {
  ...
  SetCurrentUserInState = function () {
  ...
  CollapseTableData = function (element) {
